...
// The HighlightedCommentFunc type is an adapter to allow the use of ordinary
// function as HighlightedComment mutator.
type HighlightedCommentFunc func(context.Context, *ent.HighlightedCommentMutation) (ent.Value, error)
...
// function as PickemsEvent mutator.
type PickemsEventFunc func(context.Context, *ent.PickemsEventMutation) (ent.Value, error)
